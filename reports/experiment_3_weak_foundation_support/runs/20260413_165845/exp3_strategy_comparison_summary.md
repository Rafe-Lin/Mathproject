...
- At MAX_STEPS=50, Adaptive (Ours) achieved 44.40% escape-from-C, exceeding Baseline by -7.50 pp and Rule-Based by -7.90 pp.
- At MAX_STEPS=70, Adaptive (Ours) achieved 64.60% escape-from-C, exceeding Baseline by -6.80 pp and Rule-Based by -3.20 pp.
- At MAX_STEPS=90, Adaptive (Ours) achieved 71.60% escape-from-C, exceeding Baseline by -9.00 pp and Rule-Based by -3.90 pp.
