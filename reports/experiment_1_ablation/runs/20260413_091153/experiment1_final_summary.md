...
- fig_multi_steps_efficiency.png (方法 trade-off 圖)
...
## Multi-Step Efficiency Conclusions
- Adaptive scaling (20/30/40): 20: 38.6%, 30: 60.7%, 40: 68.7%
- multi-step efficiency 圖顯示 Adaptive 在不同步數預算下維持較佳效率-效果平衡。
